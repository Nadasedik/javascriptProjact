...
var products = JSON.parse(storedProducts) ? JSON.parse(storedProducts) : [];
...
function fillCartData() {
    if (products.length == 0) {//no products
        ...
        h1.innerHTML+= '<button id="checkout"><a href="product.html" style="text-decoration: none; color: #fff;">Back</a></button>';
...
numOfItemInSummary.textContent = products.length + ' Item';
